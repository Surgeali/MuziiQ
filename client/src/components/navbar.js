      ...
      <div>
        <div style={this.styles.jumbotron}>
          ...
          <div style={this.styles.menu} id="menu">
            <button type="button" class="btn btn-danger btn-sm" id="record" onClick={this.props.recordPressed}>
            ○ 	
            </button>
            <button class="btn btn-primary btn-sm" id="start" onClick={this.props.playPressed}>
            ►	
            </button>
            <button class="btn btn-success btn-sm" id="stop" onClick={this.props.stopPressed}>
            ■
              

            </button>
            <button id="save" onClick={this.props.savePressed}>
              Save
            </button>
